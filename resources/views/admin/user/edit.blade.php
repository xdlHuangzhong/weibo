			...
			{{ csrf_field() }}
                    ...
                    <input type="hidden" name="_method" value="PUT">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <label for="user-name" class="am-u-sm-3 am-form-label">原密码 <span class="tpl-form-line-small-title">Ypass</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="password" name="ypassword" class="tpl-form-input" id="user-name" placeholder="请输入标题文字"  >
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <label for="user-name" class="am-u-sm-3 am-form-label">新密码 <span class="tpl-form-line-small-title">Pass</span></label>
                                        <div class="am-u-sm-9">
                    ...
                    <div class="am-u-sm-9">
                        <div class="am-form-group am-form-file">
                            <div class="tpl-form-file-img">
                                <p><img src="/uploads/{{ $user->pic }}" id="img1" alt="上传后显示图片"  style="max-width:350px;max-height:100px;" /></p>
                            </div>
