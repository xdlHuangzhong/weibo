                        ...
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                ...
                                <div class="widget-function am-fr">
                                    ...
                                    @endif
                                <form id="art_form" class="am-form tpl-form-line-form" action="{{ url('admin/img') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div class="am-form-group">                          
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="site" placeholder="请输入外链地址">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
