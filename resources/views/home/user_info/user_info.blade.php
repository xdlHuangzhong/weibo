...
<head>
	...
	<title>demo2</title>
	   <link rel="stylesheet" href="/userinfo/css/bootstrap.min.css">
	   <link rel="stylesheet" type="text/css" href="/userinfo/css/style.css">
...
<body>
    ...
    <script src="/userinfo/js/jquery-3.1.0.js"></script>
    		 ...
    		 $("#send").click(function(){
		      ...
		      //   //alert(time);
    		 	...
    		 	if(imgPath!=""){
	    		 	...
	    		 	if(postfix!=".PNG"&&postfix!=".JPG"&&postfix!=".GIF"&&postfix!=".JPEG"){
	    		 		...
	    		 		$(".item_msg").append("<div class='col-sm-12 col-xs-12 message' > <img src='/userinfo/img/icon.png' class='col-sm-2 col-xs-2' style='border-radius: 50%'><div class='col-sm-10 col-xs-10'><span style='font-weight: bold;''>Jack.C</span> <br><small class='date' style='color:#999'>刚刚</small><div class='msg_content'>"+content+"<img class='mypic' onerror='this.src='img/bg_1.jpg' src='file:///"+imgPath+"' ></div></div></div>");
    		 	    }
    		 	}else{
                     $(".item_msg").append("<div class='col-sm-12 col-xs-12 message' > <img src='/userinfo/img/icon.png' class='col-sm-2 col-xs-2' style='border-radius: 50%'><div class='col-sm-10 col-xs-10'><span style='font-weight: bold;''>Jack.C</span> <br><small class='date' style='color:#999'>刚刚</small><div class='msg_content'>"+content+"</div></div></div>");
    		 	}
    		  ...
    		  //添加表情包1
 			  for (var i = 1; i < 60; i++) {
				    ...
				    $(".emoji_1").append("<img src='/userinfo/img/f"+i+".png' style='width:35px;height:35px' >");
				}
				//添加表情包2
				for (var i = 1; i < 61; i++) {

				    $(".emoji_2").append("<img src='/userinfo/img/h"+i+".png' style='width:35px;height:35px' >");
				}
