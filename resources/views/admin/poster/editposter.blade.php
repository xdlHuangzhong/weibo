                        ...
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                ...
                                <div class="widget-function am-fr">
                                    ...
                                    @endif
                                <form id="art_form" class="am-form tpl-form-line-form" action="{{ url('admin/poster/'.$poster->id) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                 {{ method_field('PUT') }}
                                  <div class="am-form-group">
                                     ...
                                     <div class="am-form-group">                          
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" name="link" placeholder="请输入广告链接" value="{{ $poster->link }}">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                     <p><img src="/guanggao/{{ $poster->img }}" id="img1" alt="上传后显示图片"  style="max-width:350px;max-height:100px;" /></p>
                                                </div>
