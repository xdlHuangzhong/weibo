...
<!--feed list-->
        ...
        <div class="WB_face W_fl">
            <div class="face">
            <a target="_blank" class="W_face_radius"  href="" ><img usercard="id=2811026850&amp;refer_flag=0000015010_"  alt="" src="/lunbotu/{{ $v->user_info->pic }}" class="W_face_radius" width="50" height="50"></a>
            </div>
            </div>
...
<div class="WB_main_r" fixed-box="true">
    ...
    <div class="W_person_info">
      <div class="cover" id="skin_cover_s" style="background-image:url(&quot;profile_cover_s.jpg&quot;)">
        <div class="headpic"> <a bpfilter="page_frame" href="{{ url('home/userinfo') }}" title=""><img class="W_face_radius" src="/lunbotu/{{ $res->pic }}" width="60" height="60"></a></div>
      </div>
